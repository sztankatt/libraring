...
var validator_handle = function(validator){
    validator
        ...
        .on('error.field.bv', function(e, data){
            ...
            $(error_field_header).prepend("<strong>ERROR!</strong>");
            $(error_field).modal();
        })
}
 ...
 * */  
    var profile_update_validators = {
            ...
            current_education: $('#current_education_form').bootstrapValidator({
                container: error_field_body,
                feedbackIcons: validators_feedback_icons,
                fields: {
                    institution:{
                    ...
                    email: {
                        validators:{
                            notEmpty:{
                                message: 'Please type a new email address'
                            }                            
                        }
                    }
