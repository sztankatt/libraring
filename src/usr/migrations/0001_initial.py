...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('country', models.CharField(max_length=2, choices=[(b'UK', b'United Kingdom'), (b'HU', b'Hungary'), (b'PL', b'Poland')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education', models.ManyToManyField(related_name=b'students', to='usr.Class', blank=True)),
