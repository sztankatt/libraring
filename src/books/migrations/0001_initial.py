    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default=b'normal', max_length=20, choices=[(b'normal', b'normal'), (b'offered', b'offered'), (b'selling', b'selling'), (b'finalised', b'finalised')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer', models.ForeignKey(related_name=b'buyer_transaction_rating', to=settings.AUTH_USER_MODEL)),
                ('seller', models.ForeignKey(related_name=b'seller_transaction_rating', to=settings.AUTH_USER_MODEL)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='book',
            name='sold_to',
            field=models.ForeignKey(related_name=b'bough_book', blank=True, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='book',
